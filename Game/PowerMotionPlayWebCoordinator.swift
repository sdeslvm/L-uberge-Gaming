...
class PowerMotionPlayWebCoordinator: NSObject, WKNavigationDelegate, WKUIDelegate {
  private let callback: (PowerMotionPlayWebStatus) -> Void
  private var didStart = false

  init(onStatus: @escaping (PowerMotionPlayWebStatus) -> Void) {
