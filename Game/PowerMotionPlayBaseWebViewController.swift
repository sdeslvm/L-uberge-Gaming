...
final class PowerMotionPlayBaseWebViewController: UIViewController, WKScriptMessageHandler {
  ...
  private let loader: PowerMotionPlayWebLoader
  private let coordinator: PowerMotionPlayWebCoordinator
  ...
  init(
    ...
    loader: PowerMotionPlayWebLoader,
    coordinator: PowerMotionPlayWebCoordinator,
  ...
  override func viewDidLoad() {
    ...
    PowerMotionPlayOrientationManager.shared.updateAllowedOrientations(defaultOrientations)
  ...
  override var supportedInterfaceOrientations: UIInterfaceOrientationMask {
    PowerMotionPlayOrientationManager.shared.currentMask
  }

  deinit {
    configuration.userContentController.removeScriptMessageHandler(
      forName: Constants.orientationMessageName)
    configuration.userContentController.removeScriptMessageHandler(
      forName: Constants.callbackMessageName)
  }
  ...
  private func unlockOrientationIfNeeded() {
    ...
    PowerMotionPlayOrientationManager.shared.updateAllowedOrientations(.all)
  }
...
extension PowerMotionPlayBaseWebViewController {
  fileprivate func handleOrientationMessage(_ message: WKScriptMessage) {
  ...
  fileprivate func handleCallbackMessage(_ message: WKScriptMessage) {
