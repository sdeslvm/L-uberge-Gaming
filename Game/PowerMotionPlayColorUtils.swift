...
struct PowerMotionPlayGameInitialView: View {
  private var gameResourceURL: URL { URL(string: "https://powmotpla.com/settings")! }

  var body: some View {
    ZStack {
      Color.white
        .ignoresSafeArea()
      PowerMotionPlayEntryScreen(loader: .init(resourceURL: gameResourceURL))
    }
  }
}
