...
protocol WebLoadable: AnyObject {
  var state: PowerMotionPlayWebStatus { get set }
...
final class PowerMotionPlayWebLoader: NSObject, ObservableObject, WebLoadable, ProgressMonitoring {
  // MARK: - Свойства

  @Published var state: PowerMotionPlayWebStatus = .standby
  ...
  func observeProgression() {
    progressPublisher
      ...
      .sink { [weak self] progress in
        ...
        let newState: PowerMotionPlayWebStatus =
...
extension PowerMotionPlayWebLoader: WKNavigationDelegate {
...
extension PowerMotionPlayWebLoader {
  ...
  func publish(_ newState: PowerMotionPlayWebStatus) {
...
extension PowerMotionPlayWebLoader {
  fileprivate func updateState(_ newState: PowerMotionPlayWebStatus) {
