...
final class PowerMotionPlayOrientationManager {
  static let shared = PowerMotionPlayOrientationManager()
...
final class PowerMotionPlayAppDelegate: NSObject, UIApplicationDelegate {
  func application(
