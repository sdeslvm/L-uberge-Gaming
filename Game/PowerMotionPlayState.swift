...
protocol PowerMotionPlayLoadStateRepresentable {
  var type: PowerMotionPlayLoadState.StateType { get }
...
struct PowerMotionPlayLoadState: Equatable, PowerMotionPlayLoadStateRepresentable {
  ...
  static func idle() -> PowerMotionPlayLoadState {
    PowerMotionPlayLoadState(type: .idle, percent: nil, error: nil)
  }

  /// Создание состояния прогресса
  static func progress(_ percent: Double) -> PowerMotionPlayLoadState {
    PowerMotionPlayLoadState(type: .progress, percent: percent, error: nil)
  }

  /// Создание состояния успеха
  static func success() -> PowerMotionPlayLoadState {
    PowerMotionPlayLoadState(type: .success, percent: nil, error: nil)
  }

  /// Создание состояния ошибки
  static func error(_ err: String) -> PowerMotionPlayLoadState {
    PowerMotionPlayLoadState(type: .error, percent: nil, error: err)
  }

  /// Создание состояния отсутствия подключения
  static func offline() -> PowerMotionPlayLoadState {
    PowerMotionPlayLoadState(type: .offline, percent: nil, error: nil)
  }

  // MARK: - Методы сравнения

  /// Пользовательская реализация сравнения
  func isEqual(to other: PowerMotionPlayLoadState) -> Bool {
  ...
  static func == (lhs: PowerMotionPlayLoadState, rhs: PowerMotionPlayLoadState) -> Bool {
    lhs.isEqual(to: rhs)
  }
}
...
extension PowerMotionPlayLoadState {
...
extension PowerMotionPlayLoadState: CustomStringConvertible {
